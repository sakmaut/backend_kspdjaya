...
class R_KwitansiPelunasan extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            "pembulatan" => floatval($this->PEMBULATAN ?? 0),
            "kembalian" => floatval($this->KEMBALIAN ?? 0),
            "total_bayar" => floatval($this->TOTAL_BAYAR ?? 0),
            "jumlah_uang" => floatval($this->JUMLAH_UANG ?? 0),
