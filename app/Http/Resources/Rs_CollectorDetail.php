    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'alamat' => trim(implode(', ', array_filter([
                $this->ALAMAT ?? $this->INS_ADDRESS ?? null,
                ($this->RT ?? $this->INS_RT ?? null) ? 'RT ' . ($this->RT ?? $this->INS_RT) : null,
                ($this->RW ?? $this->INS_RW ?? null) ? 'RW ' . ($this->RW ?? $this->INS_RW) : null,
                $this->DESA ?? $this->INS_KELURAHAN ?? null,
                $this->KEC ?? $this->INS_KECAMATAN ?? null,
            ]))),
            'desa' => $this->DESA ?? $this->INS_KELURAHAN ?? "",
            'kec' => $this->KEC ?? $this->INS_KECAMATAN ?? "",
            'no_hp' =>  $this->PHONE_HOUSE ?? $this->PHONE_PERSONAL ?? "",
