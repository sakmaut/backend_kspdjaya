...
class ListBanController extends Controller
{
    ...
    private function lkbhReportView($cabangId, $request)
    {
        $query = "
        SELECT
            b.JENIS,
        ...
        FROM (
            SELECT
                CONVERT(CASE WHEN a.ACC_KEYS LIKE '%DENDA%' THEN 'DENDA' ELSE b.TITLE END USING utf8mb4) COLLATE utf8mb4_unicode_ci AS JENIS,
                CONVERT(b.BRANCH USING utf8mb4) COLLATE utf8mb4_unicode_ci AS BRANCH,
                d.ID AS BRANCH_ID,
                CONVERT(d.NAME USING utf8mb4) COLLATE utf8mb4_unicode_ci AS nama_cabang,
                CASE
                ...
                b.LOAN_NUM,
                b.PAYMENT_METHOD,
                CONVERT(b.INVOICE USING utf8mb4) COLLATE utf8mb4_unicode_ci AS no_invoice,
                CONVERT(CASE WHEN a.ACC_KEYS LIKE '%DENDA%' THEN 'DENDA' ELSE b.TITLE END USING utf8mb4) COLLATE utf8mb4_unicode_ci AS angsuran_ke,
            ...
            SELECT
                CONVERT(
                    CASE
                        ...
                        ELSE 'PELUNASAN'
                    END USING utf8mb4) COLLATE utf8mb4_unicode_ci AS JENIS,
                CONVERT(b.BRANCH USING utf8mb4) COLLATE utf8mb4_unicode_ci AS BRANCH,
                d.ID AS BRANCH_ID,
                CONVERT(d.NAME USING utf8mb4) COLLATE utf8mb4_unicode_ci AS nama_cabang,
                CASE
                ...
                CONVERT(
                    CASE
                        ...
                        WHEN a.ACC_KEYS = 'BAYAR PELUNASAN PINALTY' THEN 'PELUNASAN PINALTY'
                        ELSE 'PELUNASAN'
                    END USING utf8mb4) COLLATE utf8mb4_unicode_ci AS angsuran_ke,
                b.USER_ID AS user_id,
                '' AS admin_fee
            FROM payment_detail a
            INNER JOIN payment b ON b.ID = a.PAYMENT_ID
            ...
            SELECT
                CONVERT(
                    CASE
                        ...
                        ELSE 'PEMBULATAN'
                    END USING utf8mb4) COLLATE utf8mb4_unicode_ci AS JENIS,
                CONVERT(d.CODE_NUMBER USING utf8mb4) COLLATE utf8mb4_unicode_ci AS BRANCH,
                d.ID AS BRANCH_ID,
                CONVERT(d.NAME USING utf8mb4) COLLATE utf8mb4_unicode_ci AS nama_cabang,
                CASE
                ...
                a.METODE_PEMBAYARAN,
                CONVERT(a.NO_TRANSAKSI USING utf8mb4) COLLATE utf8mb4_unicode_ci AS no_invoice,
            ...
            SELECT
                CONVERT('PENCAIRAN' USING utf8mb4) COLLATE utf8mb4_unicode_ci AS JENIS,
                CONVERT(b.CODE_NUMBER USING utf8mb4) COLLATE utf8mb4_unicode_ci AS BRANCH,
                b.ID AS BRANCH_ID,
                CONVERT(b.NAME USING utf8mb4) COLLATE utf8mb4_unicode_ci AS nama_cabang,
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (!empty($request->dari)) {
                ...
                $arusKas = $this->lkbhReportView($cabangId, $request);
