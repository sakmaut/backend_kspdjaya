    ...
    public function listBanTest(Request $request)
    {
        try {
            ...
            $query1 = "  SELECT  CONCAT(b.CODE, '-', b.CODE_NUMBER) AS KODE, 
                                ...
                                case when coalesce(datediff(str_to_date(concat('01','$dateFrom'),'%d%m%Y'),coalesce(st.first_arr,en.first_installment)),0) < 0 then 0
                                    else coalesce(datediff(str_to_date(concat('01','$dateFrom'),'%d%m%Y'),coalesce(st.first_arr,en.first_installment)),0) end as OVERDUE_AWAL, 
                                ...
                                coalesce(st.first_arr,en.first_installment) as F_ARR_CR_SCHEDL,
