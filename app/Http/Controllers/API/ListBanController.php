    ...
    public function listBanTest(Request $request)
    {
        try {
            ...
            $query1 = "SELECT  CONCAT(b.CODE, '-', b.CODE_NUMBER) AS KODE,
                                ...
                                date_format(py.last_pay,'%d-%m-%Y') as LAST_PAY,
            ...
            foreach ($results as $result) {
                ...
                $build[] = [
                    ...
                    "TGL BAYAR" => $result->LAST_PAY == '0' || $result->LAST_PAY == '' || $result->LAST_PAY == 'null' ? null : Carbon::parse($result->LAST_PAY)->format('d/n/Y'),
