        ...
        try {
            ...
            foreach ($results as $result) {
                ...
                $build[] = [
                    ...
                    "OUT PKK AWAL" => $result->OUTSTANDING ?? 0,
                    "OUT BNG AWAL" => $result->OS_BUNGA ?? 0,
                    ...
                    "AMBC PKK_AKHIR" => $result->AMBC_PKK_AKHIR ?? 0,
                    "AMBC BNG_AKHIR" => $result->AMBC_BNG_AKHIR ?? 0,
                    "AMBC TOTAL_AKHIR" => $result->AMBC_TOTAL_AKHIR ?? 0,
