...
class Credit extends Controller
{
    ...
    private function buildData($request,$data){
        ...
        $data = [
            ...
            "tgl_cetak" => empty($check_exist->CREATED_AT) ? Carbon::parse($check_exist->CREATED_AT)->format('Y-m-d') : null,
            "tgl_awal_angsuran" => Carbon::parse($check_exist->INSTALLMENT_DATE)->format('Y-m-d')??null,
            ...
            "pasangan" => [
             ...
             "tgl_awal_pk" => Carbon::parse($check_exist->ENTRY_DATE)->format('Y-m-d')??null,
             "tgl_akhir_pk" => Carbon::parse($check_exist->END_DATE)->format('Y-m-d')??null,
