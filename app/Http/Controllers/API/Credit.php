    ...
    private function buildData($request,$data){
        ...
        $data = [
            ...
            "pasangan" => [
             ...
             "tgl_awal_pk" => !$check_exist?Carbon::parse($check_exist->ENTRY_DATE)->format('Y-m-d'):null,
             "tgl_akhir_pk" => !$check_exist?Carbon::parse($check_exist->END_DATE)->format('Y-m-d'):null,
