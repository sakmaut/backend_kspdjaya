    ...
    private function resourceDetail($data,$application)
    {
        ...
        $arrayList = [
            ...
            'data_pelanggan' =>[
                ...
                "tanggal_kawin" => checkDateIfNull($cr_personal->MARTIAL_DATE),
                "tipe" => $cr_personal->ID_TYPE??null,
                "no" => $data->ktp,
                "tgl_terbit" => checkDateIfNull($cr_personal->ID_ISSUE_DATE) ,
                "masa_berlaku" => checkDateIfNull($cr_personal->ID_VALID_DATE),
                "alamat" => $data->alamat,
                "rt" => $data->rt,
                "rw" => $data->rw,
