    ...
    private function resourceDetail($data,$application)
    {
        ...
        $arrayList = [
            ...
            'order' =>[
                ...
                "pendapatan_pribadi" => empty($cr_oder->INCOME_PERSONAL)?$cr_survey->income_personal:$cr_oder->WORK_PERIOD,
                "pendapatan_pasangan" => empty($cr_oder->INCOME_SPOUSE)?$cr_survey->income_spouse:$cr_oder->WORK_PERIOD,
                "pendapatan_lainnya" => empty($cr_oder->INCOME_OTHER)?$cr_survey->work_other:$cr_oder->WORK_PERIOD,
