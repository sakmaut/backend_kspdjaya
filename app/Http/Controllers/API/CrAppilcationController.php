    ...
    private function resourceDetail($data,$application)
    {
        ...
        $arrayList = [
            ...
            'order' =>[
                ...
                "biaya_bulanan" =>(int) empty($cr_oder->BIAYA)?$cr_survey->expenses:$cr_oder->WORK_PERIOD, 
                "pendapatan_pribadi" => (int) empty($cr_oder->INCOME_PERSONAL)?$cr_survey->income_personal:$cr_oder->WORK_PERIOD,
                "pendapatan_pasangan" =>(int) empty($cr_oder->INCOME_SPOUSE)?$cr_survey->income_spouse:$cr_oder->WORK_PERIOD,
                "pendapatan_lainnya" =>(int) empty($cr_oder->INCOME_OTHER)?$cr_survey->income_other:$cr_oder->WORK_PERIOD,
