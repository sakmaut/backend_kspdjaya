    ...
    private function resourceDetail($data,$application)
    {
        ...
        $arrayList = [
            ...
            'data_pelanggan' =>[
                ...
                "tanggal_kawin" => $data->MARTIAL_DATE == null ? null:date('Y-m-d',strtotime($data->MARTIAL_DATE)),
                "tipe" => $cr_personal->ID_TYPE??null,
                "no" => $data->ktp,
                "tgl_terbit" => $data->ID_ISSUE_DATE == null ? null:date('Y-m-d',strtotime($data->ID_ISSUE_DATE)),
                "masa_berlaku" => $data->ID_VALID_DATE == null ? null:date('Y-m-d',strtotime($data->ID_VALID_DATE)),
                "alamat" => $data->alamat,
                "rt" => $data->rt,
                "rw" => $data->rw,
