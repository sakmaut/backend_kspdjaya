...
Route::middleware(['auth:sanctum', 'time.access'])->group(function () {
    ...
    Route::post('VisitReports', [ReportController::class, 'VisitReports']);
    Route::post('FasilitasLunasReport', [ReportController::class, 'FasilitasLunasReportExport']);
    Route::get('FasilitasLunasReportExport', [ReportController::class, 'FasilitasLunasReportExport']);
    ...
    Route::post('collateral_approval', [CollateralController::class, 'collateralApproval']);
    ...
    Route::patch('cl_deploy_update/bulk', [C_Tagihan::class, 'updateBatch']);
    Route::delete('cl_deploy_delete/bulk', [C_Tagihan::class, 'deleteBatch']);

    Route::post('cl_lkp_add',  [C_Tagihan::class, 'cl_lkp_add']);
    Route::post('cl_lkp_edit',  [C_Tagihan::class, 'cl_lkp_edit']);
    Route::get('cl_lkp_list',  [C_Tagihan::class, 'cl_lkp_list']);
    Route::get('cl_lkp_detail/{id}',  [C_Tagihan::class, 'cl_lkp_detail']);
    Route::get('cl_logs/{id}',  [C_Tagihan::class, 'cl_logs']);

    Route::post('cl_survey_add',  [C_Tagihan::class, 'cl_survey_add']);
    Route::get('cl_survey_detail/{id}',  [C_Tagihan::class, 'cl_survey_detail']);
    Route::post('cl_survey_upload',  [C_Tagihan::class, 'cl_survey_upload']);
