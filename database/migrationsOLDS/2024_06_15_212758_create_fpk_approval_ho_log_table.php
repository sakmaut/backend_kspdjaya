...
return new class extends Migration
{
    ...
    {
        Schema::create('fpk_approval_ho_log', function (Blueprint $table) {
            $table->string('id')->primary();
            $table->string('application_approval_id')->nullable(false);
            $table->string('cr_application_ho')->nullable();
            $table->dateTime('cr_application_ho_time')->nullable()->default(DB::raw('CURRENT_TIMESTAMP'));
    ...
    {
        Schema::dropIfExists('fpk_approval_ho_log');
    }
};
